...
<div class="row">
  <div class="col-md-12">
      <div class="panel panel-success">
        <div class="panel-heading">Manage Warehouse</div>
        <div class="panel-body">
          <div class="div-action"">
            <button class="btn btn-success" data-toggle="modal" data-target="#addProductModal">Add new Warehouse </button>
            <a href="editProduct.php" class="btn btn-warning" role="button">Update / Delete Warehouse </a>
          </div>

          <table class="tables" id="manageProductTable" style="width:100%;">
            <thead>
              <tr>
                <th style="text-align: center;">Warehouse ID</th>
