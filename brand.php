      ...
      <div class="panel panel-success">
        ...
        <div class="panel-body">
          <div class="div-action"">
            <button class="btn btn-success" data-toggle="modal" data-target="#addBrandModal">Add </button>
            <a href="editDelBrand.php" class="btn btn-warning" role="button">Remove </a>
          </div>
          ...
          <table class="tables" id="manageBrandTable" style="width:100%;">
            <thead>
              <tr>
                ...
                <th style="text-align: center;">Pyyr</th>
              </tr>
            </thead>
          </table>
...
<div class="modal" tabindex="-1" role="dialog" id="addBrandModal">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="BrandName">Name:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="brandName" name="brandName" placeholder="Entername" required>
    </div>
  </div>
      ...
      <form class="form-horizontal" id="editBrandForm" action="php_action/editBrand.php" method="POST">
        ...
        <div class="modal-body">
          ...
          <div class="edit-brand-result">
            <div class="form-group">
              <label for="editBrandName" class="col-sm-2 control-label">Name:</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="editBrandName" placeholder="Name" name="editBrandName" autocomplete="off">
              </div>
            </div> 
